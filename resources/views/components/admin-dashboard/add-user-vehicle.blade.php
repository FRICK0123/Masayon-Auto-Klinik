@props(['cars','customerID'])

<div class="container w-75 border border-2 shadow pt-3 pb-3">
    <h2 class="text-center">Add User Vehicle</h2>
    <form action="{{ route('store_user_vehicle',$customerID) }}" method="post" class="container" enctype="multipart/form-data">
        @csrf
