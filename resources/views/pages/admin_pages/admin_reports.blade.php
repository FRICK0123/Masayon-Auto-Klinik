...
<body>
    ...
    <main>
        <x-admin-dashboard.admin-content>
                ...
                <div class="d-flex justify-content-between align-items-center pb-3 bg-white p-3 rounded-3 shadow-sm mb-4">
                    ...
                    <div class="d-flex align-items-center">
                        <form action="#" method="GET" class="search-box me-2">
                            ...
                            <button class="btn-search" type="button"><img src="{{ asset('icons/magnifying-glass-white.svg') }}" alt="Search Transaction" width="30"></button>
                    ...
                    <div class="container-fluid mt-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <form method="GET" action="{{ route('reports_transaction_filter') }}" class="d-flex align-items-center">
                                ...
                                <button class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#previousYear" type="button">Previous Reports</button>
                            </form>
                        </div>
            ...
            <div class="modal fade" id="previousYear" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Previous Year Reports</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('previous_transactions') }}" method="get">
                                <select name="year" class="form-select rounded-pill mb-5" id="yearSelect">
