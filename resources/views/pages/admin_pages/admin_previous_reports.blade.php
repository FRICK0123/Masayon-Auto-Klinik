        ...
        <x-admin-dashboard.admin-content>
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center pb-3 bg-white p-3 rounded-3 shadow-sm mb-4">
                    <h4 class="pt-2 fw-bold">REPORTS ({{ $year }})</h4>

                    <div class="d-flex align-items-center">
                        <form action="#" method="GET" class="search-box me-2">
                            @csrf
                            <button class="btn-search" type="button"><img src="{{ asset('icons/magnifying-glass-white.svg') }}" width="30"></button>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li onclick="exportPdf()" style="cursor: pointer;">
                                    <form action="{{ route('previous_transactions_pdf') }}" method="GET" class="dropdown-item" id="export_pdf">
                                        @csrf
                                        <p>Export PDF</p>
                                ...
                                <li style="cursor: pointer;" onclick="exportExcel()">
                                    <form action="{{ route('previous_transactions_excel') }}" method="GET" class="dropdown-item" id="export_excel">
                                        @csrf
                                        <input type="hidden" name="year" value="{{ $year }}">
                                        <p>Export Excel</p>                      
                                    </form>
            ...
            <div class="mb-3">
                <form action="{{ route('previous_transactions_by_date_range') }}" method="GET" class="d-flex flex-column flex-md-row align-items-center gap-2">
            ...
            <div class="d-flex justify-content-center">
                {{ $transactions->appends([['start_date' => request('start_date'), 'end_date' => request('end_date')],'year' => $year])->links() }}
            </div>
