    ...
    <main>
        <x-admin-dashboard.admin-content>
            <div class="container w-75 border border-2 shadow pt-3 pb-3">
                ...
                <form action="{{ route('walkin_maintenance') }}" method="post" class="container mt-3">
                    @csrf
                    ...
                    <input type="hidden" name="maintenance_date" id="maintenance_date" class="form-control" min="{{ date('Y-m-d') }}" value="{{ date('Y-m-d') }}">
                    <br>
