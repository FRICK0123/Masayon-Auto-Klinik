            ...
            <x-manager-dashboard.manager-content>
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center pb-2 bg-white p-2 rounded-3 shadow-sm mt-5 mt-lg-0">
                        ...
                        <form action="{{ route('maintenance_task_view') }}" method="GET" class="search-box me-2">
                            @csrf
                    ...
                    <!--Functionalities-->
                        <div class="mb-3">
                            <form action="{{ route('maintenance_task_by_date_range') }}" method="GET" class="d-flex flex-column flex-md-row align-items-center gap-2">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card bg-light">
                                    <div class="card-body @if($isNearingDate || $isNearingMileage || $isOverdue) bg-danger-subtle @endif">
                                        ...
                                        <a href="#" class="btn border border-dark btn-sm view_details"
